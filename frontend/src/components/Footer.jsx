            ...
            <div className="container mx-auto px-4 sm:px-8 relative z-10">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-24 mb-24">
                    <div className="space-y-8 text-center md:text-left flex flex-col items-center md:items-start">
                        ...
                        <p className="mt-4 text-gray-300 email-glow text-[10px] font-black tracking-[0.2em]">
                    ...
                    <div className="text-center md:text-left flex flex-col items-center md:items-start">
                        ...
                        <div className="space-y-10">
                            ...
                            <a
                                ...
                                className="inline-flex items-center gap-4 text-[9px] font-black text-gray-300 hover:text-white transition-all duration-700 ease-[0.16, 1, 0.3, 1] uppercase tracking-[0.3em] border-b border-white/5 pb-2 hover:border-white/20"
                            >
                                VIEW ON MAP
                            </a>
