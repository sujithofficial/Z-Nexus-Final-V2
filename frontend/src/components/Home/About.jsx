            ...
            <div className="container mx-auto px-4 sm:px-6">
                <div className="flex flex-col md:flex-row items-center gap-24 relative z-10">
                    <motion.div
                        ...
                        className="md:w-1/2"
                    >
                        <p className="text-[10px] font-black text-white/20 uppercase tracking-[0.5em] mb-10">ABOUT THE SYMPOSIUM</p>
                        <h2 className="text-4xl md:text-6xl font-black mb-12 leading-none tracking-tighter fast-red-gradient uppercase">
                            THE CONVERGENCE <br />
                            <span className="text-white/30 text-3xl md:text-5xl">OF MINDS</span>
                        </h2>
                        <div className="space-y-8 text-base md:text-lg text-white/40 leading-relaxed font-medium">
                            <p>
                            ...
                            <p className="border-l border-white/10 pl-8 text-sm italic py-2">
